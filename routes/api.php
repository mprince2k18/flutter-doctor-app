...
Route::get('/appointment-list-doctor/{doctor_id}', [AppController::class, 'appointment_list_doctor']);
Route::get('/appointment-list-patient/{patient_id}', [AppController::class, 'appointment_list_patient']);
Route::get('/appointment-list-patient-doctor/{patient_id}/{doctor_id}', [AppController::class, 'appointment_list_patient_doctor']);
Route::post('/give-prescription', [AppController::class, 'give_prescription']);
Route::get('/prescription-list/{paitent_id}', [AppController::class, 'prescription_list']);